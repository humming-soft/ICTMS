                                    ...
                                    <div class="col-12 col-md-12 col-lg-12">
                                        <div class="media flex-column flex-md-row mb-4">
                                            <div class="media-body text-center p-2">
                                                <h4 class="media-title step-title">Prepare the Logical Framework Matrix</h4>
                                                <ul class="list-inline list-inline-dotted mb-0">
                                                    <li class="list-inline-item">The Logical Framework Matrix (Logframe) summarises the key elements of the project plan.</li>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <hr>
                                                        ...
                                                        <div class="col-12 col-md-12 col-lg-12">
                                                            <div class="media flex-column flex-md-row mb-4">
                                                                <div class="media-body text-center p-2">
                                                                    <h4 class="media-title step-title">STEP 01 : Project Summary</h4>
                                                                    <ul class="list-inline list-inline-dotted mb-0">
                                                                        <li class="list-inline-item">The Logical Framework Matrix (Logframe) summarises the key elements of the project plan.</li>
                                                                    </ul>
                                                                </div>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-12 col-lg-12">
                                                        <div class="media flex-column flex-md-row mb-4">
                                                            <div class="media-body text-center p-2">
                                                                <h4 class="media-title step-title">STEP 02 : Assumptions</h4>
                                                                <ul class="list-inline list-inline-dotted mb-0">
