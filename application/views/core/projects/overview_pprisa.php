                                    ...
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <div class="step-head">
                                            ...
                                            <div class="step-head-text">
                                                ...
                                                <a href="<?=site_url('projects/02849/reporting-structure')?>">View/Edit →</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <div class="step-head">
                                            <div class="step-number current">03</div>
                                            <div class="step-head-text">
                                                ...
                                                <a href="<?=site_url('projects/02849/info-vendor')?>">Complete Step →</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-12 col-lg-12">
                                                ...
                                                <table class="table table-borderless table-xs my-2">
                                                    <tbody>
                                                        <tr>
                                                            <td class="font-weight-semibold" width="25%">National Strategic Plan:</td>
                                ...
                                <div class="card">
                                            ...
                                            <div class="col-12 col-md-12 col-lg-12">
                                                <ul class="media-list">
                                                    <li class="media">
                                                        ...
                                                        <div class="ml-3 align-self-center pull-right">
                                                            <div class="dropdown">
                                    ...
                                    <div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center">
                                        <ul class="list-inline list-inline-dotted mb-0">
                                            <li class="list-inline-item"><a href="#">View All</a></li>
                                        </ul>
                            ...
                            <div class="col-12 col-md-12 col-lg-12 p-0">
                                <div class="card">
                                                ...
                                                <ul class="media-list">
                                                    <li class="media">
                                                        <div class="mr-3 align-self-center">
                                                            <i class="icon-file-pdf icon-2x text-primary-300 top-0"></i>
                                                        </div>

                                                        <div class="media-body">
                                                            <div class="font-weight-semibold">budget_approval.pdf</div>
                                                    ...
                                                    <li class="media">
                                                        <div class="mr-3 align-self-center">
                                                            <i class="icon-file-word icon-2x text-pink-300 top-0"></i>
                                                        </div>

                                                        <div class="media-body">
                                                            <div class="font-weight-semibold">And_less_maternally.doc</div>
                                                            <ul class="list-inline list-inline-dotted list-inline-condensed font-size-sm text-muted">
                                                    ...
                                                    <li class="media">
                                                        <div class="mr-3 align-self-center">
                                                            <i class="icon-file-pdf icon-2x text-success top-0"></i>
                                                        </div>
                                                        
                                                        <div class="media-body">
                                                            <div class="font-weight-semibold">The_Approval_overslept.pdf</div>
                                                            <ul class="list-inline list-inline-dotted list-inline-condensed font-size-sm text-muted">
                                                                <li class="list-inline-item">Size: 4.3Mb</li>
                                                                <li class="list-inline-item">By <a href="#">Natalie</a></li>
                                                            </ul>
                                    ...
                                    <div class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center">
                                        ...
                                        <ul class="list-inline list-inline-dotted mb-0 mt-1 mt-sm-0">
                                            <li class="list-inline-item"><a href="#" class="btn btn-success btn-sm"><i class="icon-plus2 mr-1"></i> Add Document</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
