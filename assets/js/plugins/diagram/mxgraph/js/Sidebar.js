...
Sidebar.prototype.init = function()
{
	...
	this.addCausesPalette(true);
	this.addEffectsPalette(true);
...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
	 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;', 120, 60, '', 'Core Problem', null, null, 'rect rectangle box')
...
Sidebar.prototype.addCausesPalette = function(expand)
{
	var lineTags = 'line lines connector connectors connection connections arrow arrows ';
...
Sidebar.prototype.createDragSource = function(elt, dropHandler, preview, cells, bounds)
{
	...
	dragSource.getDropTarget = mxUtils.bind(this, function(graph, x, y, evt)
	{
		...
		// }
		// else 
		if (activeArrow == arrowDown || activeArrow == roundTarget)
		{
			...
			(timeOnTarget > 500 && activeArrow == null && validTarget))))
		{
			...
			{
				var elts = [roundSource, roundTarget, arrowUp,arrowDown];
	...
	dragSource.stopDrag = function()
	{
		...
		var elts = [roundSource, roundTarget, styleTarget, arrowUp, arrowDown];
