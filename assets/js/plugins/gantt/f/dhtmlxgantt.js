...
!function (t) {
    ...
    function i(t) {
        ...
        if (t.getBoundingClientRect) {
            var a = t.getBoundingClientRect(), s = document.body, o = document.documentElement || document.body.parentNode || document.body, l = window.pageYOffset || o.scrollTop || s.scrollTop, c = window.pageXOffset || o.scrollLeft || s.scrollLeft, d = o.clientTop || s.clientTop || 0, h = o.clientLeft || s.clientLeft || 0;
    ...
    t.exports = {
        getSecondsInUnit: function (t) {
            ...
            var e = [];
            for (key in t)t.hasOwnProperty(key) && e.push(t[key]);
            return e
    ...
    var n = i(0), r = (i(26), i(3)), a = i(1), s = function () {
        "use strict";
        function t(t, e, i, s) {
    ...
    t.exports = {
        ...
        }, nextSiblingTarget: function (t, e) {
            var i = this.createDropTargetObject();
            return i.targetId = t, i.nextSibling = !0, i.targetParent = e.getParent(i.targetId), i.targetIndex = e.getBranchIndex(i.targetId) + 1, i
        }, prevSiblingTarget: function (t, e) {
            var i = this.createDropTargetObject();
            return i.targetId = t, i.prevSibling = !0, i.targetParent = e.getParent(i.targetId), i.targetIndex = e.getBranchIndex(i.targetId), i
        }, firstChildTarget: function (t, e) {
            var i = this.createDropTargetObject();
            return i.targetId = t, i.targetParent = i.targetId, i.targetIndex = 0, i.child = !0, i
        }, lastChildTarget: function (t, e) {
            var i = e.getChildren(t), n = this.createDropTargetObject();
            return n.targetId = i[i.length - 1], n.targetParent = t, n.targetIndex = i.length, n.nextSibling = !0, n
        }
    }
}, function (t, e) {
    t.exports = function (t) {
    ...
    var n = i(107), r = i(104), a = i(103), s = i(102), o = i(101), l = i(100), c = i(0), d = i(1), h = i(3);
        ...
        var r = {
            init: u, createEditors: function (n) {
                ...
                var a = [], s = null, o = {
                    ...
                    setValue: function () {
                        var t = this.getState(), e = t.id, i = t.columnName, r = n.getColumn(i), a = s.getItem(e), o = this.getEditorConfig(i);
                        if (o) {
                            var l = a[o.map_to];
    ...
    var n = i(24), r = i(3), a = i(0), s = i(109), o = function (t, e, i, s) {
    ...
    o.prototype = {
        init: function (t) {
            ...
            var t = this.$getConfig(), e = this.$config.rowStore, i = e ? t.row_height * e.countVisible() : 0, n = this._tasks.full_width;
            return {
                x: this.$config.width,
            ...
            var e = this.$gantt.$services.getService("layers"), i = e.getDataRender(this.$config.bind), n = e.getDataRender(this.$config.bindLinks);
            ...
            if (this.isVisible()) {
                ...
                var l = a.prepareConfigs(s, t.min_column_width, o, n - 1, r.min_date, r.max_date, t.rtl), c = this._tasks = l[l.length - 1];
            ...
            var n = this.$getConfig(), r = this.$gantt.$services.templates(), a = [], s = null, o = null, c = null;
            (t.template || t.date) && (o = t.template || this.$gantt.date.date_to_str(t.date));
            var d = 0, h = t.count;
            !n.smart_scales || isNaN(e) || isNaN(i) || (d = l(t.left, e), h = l(t.left, i) + 1), c = t.css || function () {
                }, !t.css && n.inherit_scale_class && (c = r.scale_cell_class);
            for (var u = d; u < h && t.trace_x[u]; u++) {
                s = new Date(t.trace_x[u]);
                var g = o.call(this, s), f = t.width[u], _ = t.height, p = t.left[u], v = "", m = "", y = "";
                if (f) {
                    v = "width:" + f + "px;height:" + _ + "px;" + (n.smart_scales ? "position:absolute;left:" + p + "px" : ""), y = "gantt_scale_cell" + (u == t.count - 1 ? " gantt_last_cell" : ""), (m = c.call(this, s)) && (y += " " + m);
            ...
            var i = l(this._tasks.left, t), n = this._tasks.left[i], r = e.width[i] || e.col_width, a = 0;
            ...
            var e = new Date(t).valueOf(), i = this._tasks.trace_x_ascending, n = this._tasks.ignore_x, r = this.$gantt.getState();
            ...
            var o = this._tasks.trace_index_transition, c = a;
            if (!s)return o ? o[0] : 0;
            var d = (t - i[a]) / this._getColumnDuration(this._tasks, i[a]);
            return o ? o[c] + (1 - d) : c + d
    ...
    var n = i(20), r = i(0), a = i(3), s = function (t) {
    ...
    t.exports = function (t) {
        function e(e, a) {
            if (!t._isAllowedUnscheduledTask(e)) {
                var s = a.getItemPosition(e), o = a.$getConfig(), l = a.$getTemplates(), c = a.getItemHeight(), d = t.getTaskType(e.type), h = Math.floor((t.config.row_height - c) / 2);
                ...
                var _ = function (e, i, n, r) {
                    ...
                    if (t.getTaskType(l.type) == a.types.milestone ? s.push("gantt_milestone") : t.getTaskType(l.type) == a.types.project && s.push("gantt_project"), s.push("gantt_bar_" + t.getTaskType(l.type)), t.isSummaryTask(l) && s.push("gantt_dependent_task"), t.isSplitTask(l) && s.push("gantt_split_parent"), a.select_task && n == o.selected_task && s.push("gantt_selected"), n == o.drag_id && (s.push("gantt_drag_" + o.drag_mode), o.touch_drag && s.push("gantt_touch_" + o.drag_mode)), o.link_source_id == n && s.push("gantt_link_source"), o.link_target_id == n && s.push("gantt_link_target"), a.highlight_critical_path && t.isCriticalTask && t.isCriticalTask(l) && s.push("gantt_critical_task"), o.link_landing_area && o.link_target_id && o.link_source_id && o.link_target_id != o.link_source_id) {
                        var c = o.link_source_id, d = o.link_from_start, h = o.link_to_start, u = t.isLinkAllowed(c, n, d, h), g = "";
    ...
    var n = i(1), r = i(0), a = i(3), s = i(108), o = (i(11), function (t, e, i, n) {
    ...
    o.prototype = {
        init: function (t) {
            ...
            if (i && "*" != i) {
                var n = 1 * i;
                isNaN(n) ? gantt.assert(!1, "Wrong " + e + " value of column " + t.name) : t[e] = n
            }
        }, setSize: function (t, e) {
            ...
            var t = this.$getConfig(), e = this.$config.rowStore, i = e ? t.row_height * e.countVisible() : 0, n = this._getGridWidth();
            return {
                x: this.$state.width,
                y: this.$state.height,
                contentX: this.isVisible() ? n : 0,
            ...
            var t = this.$gantt, e = this.$getConfig(), i = this.$gantt.locale, n = this.$gantt.templates, r = this.getGridColumns();
            e.rtl && (r = r.reverse());
            for (var a = [], s = 0, o = i.labels, l = e.scale_height - 1, c = 0; c < r.length; c++) {
                ...
                var f = t._sort && h.name == t._sort.name ? "<div class='gantt_sort gantt_" + t._sort.direction + "'></div>" : "", _ = ["gantt_grid_head_cell", "gantt_grid_head_" + h.name, d ? "gantt_last_cell" : "", n.grid_header_class(h.name, h)].join(" "), p = "width:" + (u - (d ? 1 : 0)) + "px;", v = h.label || o["column_" + h.name];
                v = v || "";
    ...
    var n = i(2), r = i(1), a = (i(0), function (t) {
        "use strict";
        function e(e, i, n) {
        ...
        return n(e, t), e.prototype.destructor = function () {
            ...
            if (t.length)for (var i = t[0].$parent._xLayout ? "width" : "height", n = t[0].$parent.getNextSibling(t[0].$id) ? 1 : -1, r = 0; r < t.length; r++) {
                var a = t[r].getSize(), s = n > 0 ? t[r].$parent.getNextSibling(t[r].$id) : t[r].$parent.getPrevSibling(t[r].$id);
            ...
            var e = null, i = ["width", "height", "paddingTop", "paddingBottom", "paddingLeft", "paddingRight", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"], n = {
            ...
            var e = this._getAutosizeMode(t), i = this._getBoxStyles(this.$container), n = this.getContentSize(t), r = this.$container;
    ...
    t.exports = function (t) {
        var e = i(19);
        t.assert = i(29)(t), t.init = function (t, e, i) {
            ...
            var i = e, n = {
                render: i.render, focus: i.focus, set_value: function (e, r, a, s) {
                    ...
                    if (t.callEvent("onSectionToggle", [t._lightbox_id, i]), e.style.display = i.disabled ? "none" : "block", i.button) {
                        var n = e.previousSibling.querySelector(".gantt_custom_button_label"), r = t.locale.labels, a = i.disabled ? r[i.name + "_enable_button"] : r[i.name + "_disable_button"];
                        n.innerHTML = a
                    }
                    t.resizeLightbox()
    ...
    t.exports = function (t) {
        ...
        return n(r, e), r.prototype.render = function (e) {
            var i = "<div class='gantt_time_selects'>" + t.form_blocks.getTimePicker.call(this, e) + "</div>", n = t.locale.labels[t.config.duration_unit + "s"], r = e.single_date ? " style='display:none'" : "", a = e.readonly ? " disabled='disabled'" : "", s = "<div class='gantt_duration' " + r + "><input type='button' class='gantt_duration_dec' value='âˆ’'" + a + "><input type='text' value='5' class='gantt_duration_value'" + a + " " + t._waiAria.lightboxDurationInputAttrString(e) + "><input type='button' class='gantt_duration_inc' value='+'" + a + "> " + n + " <span></span></div>";
            return "<div style='height:" + (e.height || 30) + "px;padding-top:0px;font-size:inherit;' class='gantt_section_time'>" + i + " " + s + "</div>"
        }, r.prototype.set_value = function (e, i, n, r) {
            var o, l, c, d, h = r, u = e.getElementsByTagName("select"), g = e.getElementsByTagName("input"), f = g[1], _ = [g[0], g[2]], p = e.getElementsByTagName("span")[0], v = r._time_format_order;

            function m() {
                var i = a.call(t, e, r), o = s.call(t, e, r), l = t.calculateEndDate({
                    start_date: i,
                    duration: o,
                    task: n
                });
    ...
    t.exports = function (t) {
        ...
        return n(r, e), r.prototype.render = function (e) {
            var i = t.form_blocks.getTimePicker.call(this, e), n = "<div style='height:" + (e.height || 30) + "px;padding-top:0px;font-size:inherit;text-align:center;' class='gantt_section_time'>";
            ...
            var h = n[d.start_date] || new Date, u = n[d.end_date] || t.calculateEndDate({
                    start_date: h,
                    duration: 1,
                    task: n
                });
    ...
    t.exports = function (t) {
        var e = i(1), n = i(4), r = i(50)(t), a = i(49)(t), s = i(48)(t), o = i(8)(t), l = i(46)(t), c = i(45)(t), d = i(44)(t), h = i(43)(t), u = i(8)(t);
        ...
        t._lightbox_methods = {}, t._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>", t.$services.getService("state").registerProvider("lightbox", function () {
            ...
            for (var s = this._get_typed_lightbox_config(this.getLightboxType()), o = 0; o < s.length; o++) {
                ...
                if (this.form_blocks[l.type]) {
                    var c = document.getElementById(l.id).nextSibling, d = this.form_blocks[l.type], h = t._resolve_default_mapping(s[o]), u = this.defined(n[h]) ? n[h] : l.default_value;
    ...
    t.exports = function (t) {
        t.isUnscheduledTask = function (e) {
            ...
            var i = this.getTask(e), n = (this.getTaskType(i.type), i.start_date ? i.start_date.valueOf() : null), r = i.end_date ? i.end_date.valueOf() : null;
    ...
    i.prototype = {
        getWorkHours: function () {
            ...
            var t = this.argumentsHelper.getDurationArguments.apply(this.argumentsHelper, arguments), e = t.start_date, i = t.end_date, n = t.unit, r = t.step;
            ...
            var t = this.argumentsHelper.getDurationArguments.apply(this.argumentsHelper, arguments), e = t.start_date, i = t.end_date, n = t.unit;
            t.step;
            return !!n && (e = new Date(e), i = new Date(i), e.valueOf() < i.valueOf())
        }, calculateEndDate: function () {
            var t = this.argumentsHelper.calculateEndDateArguments.apply(this.argumentsHelper, arguments), e = t.start_date, i = t.duration, n = t.unit, r = t.step;
    ...
    a.prototype = {
        units: ["year", "month", "week", "day", "hour", "minute"], _getUnitOrder: function (t) {
            ...
            var l = this.$gantt.date.day_start(new Date(a)), c = a, d = this._getWorkUnitsBetweenGeneric(s, o, i, n), h = this._getWorkUnitsBetweenGeneric(l, c, i, n), u = this._getWorkHoursForRange(o, l);
            return u = u / n + d + h
            ...
            var t = this.argumentsHelper.calculateEndDateArguments.apply(this.argumentsHelper, arguments), e = t.start_date, i = t.duration, n = t.unit, r = t.step, a = t.duration >= 0 ? 1 : -1;
            ...
            var e = t.unit, i = this.$gantt.date[e + "_start"](new Date(t.date)), n = new Date(i), r = new Date(i), a = !0, s = 0, o = "any" == t.dir || !t.dir, l = 1;
            "past" == t.dir && (l = -1);
    ...
    var n = i(58), r = i(55), a = i(53), s = i(0);
    t.exports = function (t) {
    ...
    t.exports = function (t) {
        ...
        for (var s in t._waiAria = {
            getAttributeString: function (t) {
                ...
                var r = t.config.links, a = e.type == r.finish_to_start || e.type == r.start_to_start, s = e.type == r.start_to_start || e.type == r.start_to_finish, o = t.locale.labels.link + " " + t.templates.drag_link(e.source, s, e.target, a);
    ...
    function r(t) {
        ...
        function l(e, i, n) {
            var r = t.config.resource_property, a = t.getTask(i), s = a[r] || [];
            Array.isArray(s) || (s = [s]);
        ...
        return t.$data.tasksStore.attachEvent("onStoreUpdated", function () {
            ...
            void 0 !== i ? l(e, i, n) : t.getTaskBy(r, e).forEach(function (t) {
                l(e, t.id, n)
            });
            return n
        }, {
            renderLine: function (t, e) {
                for (var i = e.$getConfig(), n = e.$getTemplates(), r = a(t, i.resource_property, e.getScale(), e), s = [], o = 0; o < r.length; o++) {
                    var l = r[o], c = n.resource_cell_class(l.start_date, l.end_date, t, l.tasks), d = n.resource_cell_value(l.start_date, l.end_date, t, l.tasks);
                    if (c || d) {
                ...
                for (var n = i.$getConfig(), r = i.$getTemplates(), l = a(e, n.resource_property, i.getScale(), i), c = [], d = {}, h = e.capacity || i.$config.capacity || 24, u = 0; u < l.length; u++) {
                    var g = l[u], f = r.histogram_cell_class(g.start_date, g.end_date, e, g.tasks), _ = r.histogram_cell_label(g.start_date, g.end_date, e, g.tasks), p = r.histogram_cell_allocated(g.start_date, g.end_date, e, g.tasks), v = r.histogram_cell_capacity(g.start_date, g.end_date, e, g.tasks);
                ...
                if (c.length) {
                    ...
                    var b = function (e, i, n) {
                        for (var r = i.getScale(), a = document.createElement("div"), l = 0; l < r.trace_x.length; l++) {
                            var c = r.trace_x[l], d = r.trace_x[l + 1] || t.date.add(c, r.step, r.unit), h = r.trace_x[l].valueOf(), u = Math.min(e[h] / n, 1) || 0;
                            if (u < 0)return null;
                ...
                return k
            }, filterTasks: i, getResourceAssignments: getResourceAssignments
        }
    }
    ...
    t.exports = function (t) {
        ...
        function u() {
            var e = !!document.querySelector(".gantt_drag_marker"), i = !!document.querySelector(".gantt_drag_marker.gantt_grid_resize_area"), n = !!document.querySelector(".gantt_link_direction");
        ...
        function f(t) {
            t ? (g(!0), c.started || (c.x = d.x, c.y = d.y, c.started = !0)) : (s && (clearInterval(s), s = null), g(!1), c.started = !1)
        }
        ...
        function p() {
            if (!u())return f(!1), !1;
            var e = n.getNodePosition(h()), r = d.x - e.x, a = d.y - e.y, s = o ? 0 : v(r, e.width, c.x - e.x), l = v(a, e.height, c.y - e.y), g = t.getScrollState(), _ = g.y, p = g.inner_height, m = g.height, y = g.x, k = g.inner_width, b = g.width;
            l && !p ? l = 0 : l < 0 && !_ ? l = 0 : l > 0 && _ + p >= m + 2 && (l = 0), s && !k ? s = 0 : s < 0 && !y ? s = 0 : s > 0 && y + k >= b && (s = 0);
    ...
    t.exports = function (t) {
        for (var e = [i(72), i(71), i(70), i(69), i(68), i(67), i(66), i(65)], n = 0; n < e.length; n++)e[n] && e[n](t)
    }
}, function (t, e, i) {
    var n = i(0), r = i(3), a = function (t) {
    ...
    a.prototype = {
        setTransactionMode: function (t, e) {
            ...
            if (t) {
                ...
                }, a = this.serverProcessor + (this._user ? n.urlSeparator(this.serverProcessor) + ["dhx_user=" + this._user, "dhx_version=" + this.obj.getUserData(0, "version")].join("&") : ""), s = this._applyPayload(a);
                switch (this._tMode) {
                    case"GET":
            ...
            var t = this.$gantt.ajax, e = this, i = this.obj.getUserData(0, "version"), n = this.serverProcessor + t.urlSeparator(this.serverProcessor) + ["dhx_user=" + this._user, "dhx_version=" + i].join("&");
    ...
    var n = i(20), r = i(0), a = (i(3), i(21)), s = function (t) {
    ...
    s.prototype = r.mixin({
        _buildTree: function (t) {
            ...
            if (t != i) {
                i = i || this.$getRootId();
                var r = this.getItem(t), a = this.getParent(r.id), s = (this.getChildren(this.getParent(r.id)), this.getChildren(i));
    ...
    var n = i(0), r = i(81), a = i(80), s = i(21), o = i(79), l = i(78), c = i(77);
    ...
    var n = i(1), r = function (t, e) {
        ...
        u.attachEvent("onBeforeDragStart", e.bind(function (i, r) {
            ...
            return S && (_ && e.refreshTask(_, !1), y && e.refreshTask(y, !1)), S && f(c.marker), function (i, n, r, a) {
                ...
                var f = Math.sin(g), _ = Math.cos(g), v = Math.round(n), m = Math.round(i), y = ["-webkit-transform: rotate(" + g + "rad)", "-moz-transform: rotate(" + g + "rad)", "-ms-transform: rotate(" + g + "rad)", "-o-transform: rotate(" + g + "rad)", "transform: rotate(" + g + "rad)", "width:" + Math.round(d) + "px"];
            ...
            if (t.link_source_id && t.link_target_id && t.link_source_id != t.link_target_id) {
                var i = e._get_link_type(t.link_from_start, t.link_to_start), n = {
                    ...
                    return t = function (t, e) {
                        ...
                        return {
                            ...
                            _resize_progress: function (e, i, n) {
                                var r = this._drag_task_coords(e, n), a = t.$getConfig().rtl ? r.start - n.pos.x : n.pos.x - r.start, s = Math.max(0, a);
                                e.progress = Math.min(1, s / Math.abs(r.end - r.start))
                            },
                            _find_max_shift: function (t, i) {
                                var n;
                                for (var r in t) {
                                    var a = t[r], s = e.getTask(a.id), o = this._drag_task_coords(s, a), l = e.posFromDate(new Date(e.getState().min_date)), c = e.posFromDate(new Date(e.getState().max_date));
                                    if (o.end + i > c) {
                                        var d = c - o.end;
                                        (d < n || void 0 === n) && (n = d)
                                    } else if (o.start + i < l) {
                            ...
                            on_mouse_move: function (t) {
                                if (this.drag.start_drag) {
                                    var i = n.getRelativeEventPosition(t, e.$task_data), r = this.drag.start_drag.start_x, s = this.drag.start_drag.start_y;
    ...
    var n = i(0), r = i(88), a = i(87), s = i(1), o = function (t) {
        var e = t.$services;
        return {
            onCreated: function (e) {
                var s = e.$config;
                ...
                this._mouseDelegates.delegate("click", "gantt_task_link", t.bind(function (t, e) {
                    ...
                    var n = s.getRelativeEventPosition(e, t.$task_data), r = t.dateFromPos(n.x), a = Math.floor(t.columnIndexByDate(r)), o = t.getScale().trace_x[a];
    ...
    t.exports = {
        removeLineHighlight: function (t) {
            ...
            var a = function (t, e) {
                var i = n.getNodePosition(e.$grid_data), r = n.getRelativeEventPosition(t, e.$grid_data), a = e.$config.rowStore, s = i.x, o = r.y - 10, l = e.$getConfig();
                o < i.y && (o = i.y);
            ...
            s || ((s = document.createElement("div")).className = "gantt_drag_marker gantt_grid_dnd_marker", s.innerHTML = "<div class='gantt_grid_dnd_marker_line'></div>", s.style.pointerEvents = "none", document.body.appendChild(s), e.markerLine = s), t.child ? function (t, e, i) {
                ...
                var n = function (t, e) {
                    var i = e.$config.rowStore, n = {
                        x: 0,
                        y: 0
                    }, a = e.$grid_data.querySelector(".gantt_tree_indent"), s = 15, o = 0;
    ...
    t.exports = function (t, e, i, r) {
        var a;
        if (t !== r.$getRootId())a = e < .25 ? n.prevSiblingTarget(t, r) : !(e > .6) || r.hasChild(t) && r.getItem(t).$open ? n.firstChildTarget(t, r) : n.nextSiblingTarget(t, r); else {
            var s = r.$getRootId();
            a = r.hasChild(s) && i >= 0 ? n.lastChildTarget(s, r) : n.firstChildTarget(s, r)
        }
        return a
    }
}, function (t, e, i) {
    ...
    function r(t, e, i, r) {
        for (var a = t; i.exists(a);) {
            var s = i.calculateItemLevel(i.getItem(a));
            if ((s === e || s === e - 1) && i.getBranchIndex(a) > -1)break;
            a = r ? i.getPrev(a) : i.getNext(a)
        }
        return i.exists(a) ? i.calculateItemLevel(i.getItem(a)) === e ? r ? n.nextSiblingTarget(a, i) : n.prevSiblingTarget(a, i) : n.firstChildTarget(a, i) : null
    }
    ...
    t.exports = function (t, e, i, r, o) {
        var l;
        if (t !== r.$getRootId())e < .5 ? r.calculateItemLevel(r.getItem(t)) === o ? l = n.prevSiblingTarget(t, r) : (l = a(t, o, r)) && (l = s(t, o, r)) : r.calculateItemLevel(r.getItem(t)) === o ? l = n.nextSiblingTarget(t, r) : (l = s(t, o, r)) && (l = a(t, o, r)); else {
            var c = r.$getRootId(), d = r.getChildren(c);
            l = n.createDropTargetObject(), l = d.length && i >= 0 ? a(function (t) {
    ...
    var n = i(1), r = i(9), a = i(92), s = i(91), o = i(90);
    t.exports = {
        init: function (t, e) {
            ...
            function d(t) {
                ...
                }(t), r = null, o = e.$config.rowStore, c = !e.$getConfig().order_branch_free, d = n.getRelativeEventPosition(t, e.$grid_data).y;
                return i !== o.$getRootId() && (r = (d - e.getItemTop(i)) / e.getItemHeight()), c ? a(i, r, d, o, l.config.level) : s(i, r, d, o)
            }
        }
    }
}, function (t, e, i) {
    ...
    var n = i(0), r = i(94), a = i(93), s = (i(11), function (t) {
        return {
            onCreated: function (e) {
    ...
    t.exports = function (t) {
        var e = {
            ...
            get_wrapper_sizes: function (t, e) {
                var i, n = e.$getConfig(), r = n.link_wrapper_width, a = (n.link_line_width, t.y + (n.row_height - r) / 2);
                switch (t.direction) {
                    case this.dirs.left:
            ...
            path: [], clear: function () {
                ...
                var r = i.$getConfig(), a = (r.links, this.get_line_type(e, r)), s = a.from_start, o = a.to_start, l = t.getTask(e.source), c = t.getTask(e.target), d = n(l, i), h = n(c, i);
        ...
        return function (n, r) {
            ...
            var _ = c[c.length - 1].direction, p = function (t, i, n) {
                var r = n.$getConfig(), a = document.createElement("div"), s = t.y, o = t.x, l = r.link_arrow_size, c = r.row_height, d = "gantt_link_arrow gantt_link_arrow_" + i;
                switch (i) {
                    case e.dirs.right:
                        s -= (l - c) / 2, o -= l;
                        break;
    ...
    t.exports = function (t) {
        return function (e, i) {
            ...
            var u = t.getGlobalTaskIndex(e.id) % 2 != 0, g = r.task_row_class(e.start_date, e.end_date, e), f = "gantt_task_row" + (u ? " odd" : "") + (g ? " " + g : "");
    ...
    t.exports = {
        init: function (t, e) {
            ...
            a.attachEvent("onBeforeFocus", function (e) {
                ...
                var s = t.locateCell(r.target), o = !!s && t.getEditorConfig(s.columnName), l = t.getState(), c = n.constants.KEY_CODES, d = r.keyCode, h = !1;
                switch (d) {
                    case c.ENTER:
                    ...
                    case c.TAB:
                        ...
                        break;
                    default:
                        t.isVisible() ? h = !0 : (d >= 48 && d <= 57 || d > 95 && d < 112 || d >= 64 && d <= 91 || d > 185 && d < 193 || d > 218 && d < 223) && o && !t.isVisible() && (i.startEdit(s.id, s.columnName), h = !0)
                }
                return !h
            })
    ...
    var n = i(2), r = i(1), a = i(0), s = i(13), o = (i(3), function (t) {
        "use strict";
        function e(e, i, n, r) {
        ...
        return n(e, t), e.prototype.init = function (t) {
            ...
            var n = this._getScrollSize(), r = (this._isVertical() ? i : e) - this._getScrollOffset() + (this._isHorizontal() ? 1 : 0);
            ...
            var e = this._isHorizontal() ? "width" : "height", i = this._isHorizontal() ? this.$scroll_hor : this.$scroll_ver, n = this._getScrollOffset(), a = i.firstChild;
    ...
    var n = function (t) {
        return function (e) {
            ...
            function a(t) {
                var i = (t = t || window.event).target || t.srcElement, n = e.locate(i), r = e.locate(i, e.config.link_attribute), a = !e.checkEvent("onContextMenu") || e.callEvent("onContextMenu", [n, r, t]);
            ...
            function l(t) {
                (t = t || window.event).target || t.srcElement;
                var n = e.locate(t), r = s(t, i.doubleclick), a = !e.checkEvent("onTaskDblClick") || e.callEvent("onTaskDblClick", [n, t]);
                if (a) {
                    if (!o(r, t, n))return;
    ...
    var n = i(119), r = i(117), a = i(116), s = i(7), o = i(25), l = i(113), c = i(112), d = i(111), h = i(110), u = i(12), g = i(23), f = i(23), _ = i(12), p = i(12), v = i(11), m = i(22), y = i(99), k = i(98), b = i(97), $ = i(96), x = i(95), w = i(89), S = i(86);
    t.exports = {
        init: function (t) {
            function e(e, i) {
                var n = i(t);
    ...
    i(1);
    t.exports = function (t) {
        var e = "data-dhxbox", r = null;

        function a(t, e) {
            var i = t.callback;
            _.hide(t.box), r = t.box = null, i && i(e)
        }

        function s(t) {
            if (r) {
                var e = (t = t || event).which || event.keyCode, i = !1;
                if (v.keyboard) {
                    if (13 == e || 32 == e) {
        ...
        function d(i, d, h) {
            var u = i.tagName ? i : function (i, s, o) {
                var d = document.createElement("div"), h = (t.locale, n.uid());
                t._waiAria.messageModalAttr(d, h), d.className = " gantt_modal_box dhtmlx_modal_box gantt-" + i.type + " dhtmlx-" + i.type, d.setAttribute(e, 1);
                var u = "";
                if (i.width && (d.style.width = i.width), i.height && (d.style.height = i.height), i.title && (u += '<div class="gantt_popup_title dhtmlx_popup_title">' + i.title + "</div>"), u += '<div class="gantt_popup_text dhtmlx_popup_text" id="' + h + '"><span>' + (i.content ? "" : i.text) + '</span></div><div  class="gantt_popup_controls dhtmlx_popup_controls">', s && (u += l(c(i.ok, t.locale.labels.message_ok, "OK"), "ok", !0)), o && (u += l(c(i.cancel, t.locale.labels.message_cancel, "Cancel"), "cancel", !1)), i.buttons)for (var g = 0; g < i.buttons.length; g++) {
                    var f = i.buttons[g];
                ...
                if (u += "</div>", d.innerHTML = u, i.content) {
                    var _ = i.content;
                    "string" == typeof _ && (_ = document.getElementById(_)), "none" == _.style.display && (_.style.display = ""), d.childNodes[i.title ? 1 : 0].appendChild(_)
                }
            ...
            var g = Math.abs(Math.floor(((window.innerWidth || document.documentElement.offsetWidth) - u.offsetWidth) / 2)), f = Math.abs(Math.floor(((window.innerHeight || document.documentElement.offsetHeight) - u.offsetHeight) / 2));
            return "top" == i.position ? u.style.top = "-3px" : u.style.top = f + "px", u.style.left = g + "px", u.onkeydown = s, _.focus(u), i.hidden && _.hide(u), t.callEvent("onMessagePopup", [u]), u
        }
    ...
    t.exports = function (t) {
        return {
            cache: !0, method: "get", parse: function (t) {
                ...
                var c = window.XMLHttpRequest && !n.isIE ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP"), d = null !== navigator.userAgent.match(/AppleWebKit/) && null !== navigator.userAgent.match(/Qt/) && null !== navigator.userAgent.match(/Safari/);
    ...
    i(15), t.exports = function () {
        var t = new function () {
            this.constants = i(130), this.version = "6.0.0", this.templates = {}, this.ext = {}, this.keys = {
                edit_save: this.constants.KEY_CODES.ENTER,
                edit_cancel: this.constants.KEY_CODES.ESC
            }
        };
        i(129)(t), t.$services = t.$inject(i(128)), t.config = t.$inject(i(127)), t.ajax = i(126)(t), t.date = i(125)(t);
        var e = i(124)(t);
        ...
        }), t.mixin(t, o.layersApi), i(85)(t), t.$services.setService("layers", function () {
            return o.layersService
        });
        var l = i(84);
        return t.mixin(t, l()), i(83)(t), i(76)(t), i(73)(t), i(64)(t), i(63)(t), i(62)(t), i(61)(t), i(60)(t), i(59)(t), i(52)(t), i(51)(t), i(42)(t), i(41)(t), i(40)(t), i(39)(t), i(38)(t), i(37)(t), i(36)(t), i(35)(t), i(34)(t), i(33)(t), i(32)(t), i(31)(t), i(16)(t), i(30)(t), i(28)(t), t
    }
}, function (t, e) {
    t.exports = function (t) {
    }
