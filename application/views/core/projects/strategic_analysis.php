                                                            ...
                                                            <div class="col-12 col-md-12 col-lg-12">
                                                                <div class="media flex-column flex-md-row mb-4">
                                                                    ...
                                                                    <div class="align-self-md-center ml-md-3 mt-2 mt-md-0">
                                                                        <a data-toggle="modal" data-target="#add-strat" class="btn bg-success"><i class="icon-plus2 mr-1"></i> Add</a>
                                                                    </div>
                                                                </div>
                                                                <div class="row" id="strat-groups">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-12 col-lg-12">
                                                        <div class="media flex-column flex-md-row mb-4">
                                                            ...
                                                            <div class="align-self-md-center ml-md-3 mt-2 mt-md-0">
                                                                <a data-toggle="modal" class="btn bg-success" data-target="#add-criteria"><i class="icon-plus2 mr-1"></i> New Criteria</a>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-12 col-md-12 col-lg-12">
                                                                                ...
                                                                                <table class="table table-bordered ictms-table">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="p-0">  
                                                                                                <ul class="data-details-list m-0 list-criteria" style="padding-inline-start:0">
                                                                                                    <li>
...
<div class="hmwks-modal modal animated" id="add-strat" tabindex="-1">
                ...
                <div class="hmwks-slider-w">
                    <div class="hmwks-slide">
                        <div class="hmwks-content with-gradient text-center" style="padding:30px">
                            <h4 class="hmwks-title">Add New Strategy</h4>
                            <div class="hmwks-text">Please enter the new strategy name</div>
                            <div class="row text-left">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input type="text" id="strat_name" name="strat_name" class="form-control form-control-lg" placeholder="Enter Strategy Name..">
                                    </div>
                                    <div class="text-right">                                           
                                        <button type="button" data-dismiss="modal" class="btn btn-light ml-3">Cancel</button>
                                        <button type="button" data-dismiss="modal" id="add-strategy" class="btn bg-blue"><i class="icon-plus2 mr-1"></i> Add</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="hmwks-modal modal animated" id="add-criteria" tabindex="-1">
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content"><button aria-label="Close" class="close" data-target="#hmwks-cnp" data-toggle="modal" data-dismiss="modal"
            type="button"><span class="close-label">Close</span><span class="icon-cross"></span></button>
            <div class="popup-body">
                <div class="hmwks-slider-w">
                    <div class="hmwks-slide">
                        <div class="hmwks-content with-gradient text-center" style="padding:30px">
                            <h4 class="hmwks-title">Add New Criteria</h4>
                            <div class="hmwks-text">Please enter the new Criteria Information</div>
                            <div class="row text-left">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Enter Criteria :</label>
                                        <input type="text" id="crit_name" name="crit_name" class="form-control form-control-lg" placeholder="Enter Criteria..">
                                    </div>
                                    <div class="form-group">
