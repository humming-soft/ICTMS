<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        ...
        <h4><i class="icon icon-home4 mr-1"></i> Dashboard</h4>
            <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
        </div>

        <div class="header-elements d-none">
            <div class="d-flex justify-content-center p-2">
                <a href="#" class="btn bg-blue-800 btn-sm no-loader" data-toggle="modal" data-target="#hmwks-cnp"><i class="icon-plus3 mr-1"></i> Create Project</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content"><button aria-label="Close" class="close" data-dismiss="modal"
            ...
            <div class="hmwks-slider-w">
                    ...
                    <div class="hmwks-slide">
                        <div class="hmwks-content with-gradient text-center">
                            <h4 class="hmwks-title">National Strategic Plan</h4>
                            <div class="hmwks-text">Select the National Strategic Plan that aligns with the Project.</div>
                            <div class="row">
                                <div class="col-sm-12">
