...
function chkuser($username, $email)
	...
	{
	$query ="select a.sec_group_desc,a.icon_path icon_group,b.sec_obj_id,b.sec_obj_desc,b.url_path,b.icon_path,c.view_opt from sec_group a,sec_object b,sec_role_permission c where a.sec_group_id=b.sec_group_id and c.sec_role_id=".$roleid." and c.view_opt=1 and b.sec_obj_id=c.sec_obj_id order by a.seq_no asc, b.seq_no asc";
