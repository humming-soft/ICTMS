...
Hmwks.ComponentsGroup['Server Components'] = ["components/products", "components/product", "components/categories", "components/manufacturers", "components/search", "components/user", "components/product_gallery", "components/cart", "components/checkout", "components/filters", "components/product", "components/slider"];


Hmwks.Components.add("components/product", {
    name: "Product",
...
Hmwks.Components.add("components/products", {
    name: "Products",
...
Hmwks.Components.add("components/manufacturers", {
    name: "Manufacturers",
...
Hmwks.Components.add("components/categories", {
    name: "Categories",
...
Hmwks.Components.add("components/search", {
    name: "Search",
...
Hmwks.Components.add("components/user", {
    name: "User",
...
Hmwks.Components.add("components/product_gallery", {
...
Hmwks.Components.add("components/cart", {
    name: "Cart",
...
Hmwks.Components.add("components/checkout", {
    name: "Checkout",
...
Hmwks.Components.add("components/filters", {
    name: "Filters",
...
Hmwks.Components.add("components/slider", {
    name: "Slider",
